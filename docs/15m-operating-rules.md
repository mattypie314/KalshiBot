...
- Entry looks during minutes **2–6** of the window (`:00–:01` waits). The live Pi timer fires at `:02`.
...
**When to look**
- Minutes **2–6** of each 15m window, **or**
...
- Any Yes under **45¢** (BTC, ETH, …); any Yes over **55¢**; any No whose labeled join (`1 − Yes ask`) is under **55¢**.
...
**Trade only BTC/ETH 15m on shard 2, settlement-index fair value, maker limits, one Pass per window (higher |net_edge| if both would Pass), 10¢ net floor, sit any Yes under 45¢ and any Yes over 55¢, sit No unless labeled join ≥ 55¢ (`1 − Yes ask`), $1–$2 risk, $5 pot — quit at $0, ask at $10, flat is fine.**
